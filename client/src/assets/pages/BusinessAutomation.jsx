      ...
      <div className="w-full max-w-[1200px] flex flex-col gap-12">
        ...
        <div className="w-full">
          <p className="text-sm sm:text-base md:text-lg leading-relaxed">
            Business Automation is transforming how companies operate, helping
            you stay ahead of the competition. Our solutions are designed to
            ...
            we build automation tailored to your unique needs.
            <br />
            <br />
            Whether you want to streamline your sales process, personalize
            customer journeys, or integrate automation into existing systems,
            our team ensures smooth implementation and measurable results. With
        ...
        <div className="w-full">
          ...
          <ul className="flex flex-col gap-6">
            <li>
              ...
              >
                Built around your unique business model to maximize efficiency.
              </p>
            </li>
            ...
            <li>
              ...
              >
                From strategy and planning to deployment, we handle the full
                automation journey.
              </p>
            </li>
            ...
            <li>
              ...
              >
                Easy-to-manage automation systems that grow with your business.
              </p>
            </li>
            <li>
              <h4 className="text-base sm:text-lg md:text-xl font-semibold">
              ...
              >
                Measurable results that boost efficiency, accuracy, and customer
                satisfaction.
              </p>
            </li>
          </ul>
